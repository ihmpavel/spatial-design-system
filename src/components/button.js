...
AFRAME.registerComponent('button', {
  ...
  updateIconPosition(iconpos) {
    ...
    const iconWidth =
      icon !== '' && !this.data.textonly ? 0.2 * this.el.getAttribute('sizeCoef') : 0
  ...
  createButton(widthArg = 1, heightArg = 0.4) {
    ...
    if (this.data.outlined) {
      buttonGeometry.translate(0, 0, -0.005)
    }
  ...
  animateButtonOnClick() {
    ...
    new TWEEN.Tween(buttonMesh.material.color)
      ...
      .onUpdate(() => {
        buttonMesh.material.color.setRGB(
          buttonMesh.material.color.r,
          buttonMesh.material.color.g,
          buttonMesh.material.color.b
        )
      })
      .start()
    ...
    if (shadowMesh) {
      new TWEEN.Tween(shadowMesh.material.color)
        ...
        .easing(TWEEN.Easing.Quadratic.InOut)
        .onUpdate(() => {
          shadowMesh.material.color.setRGB(
            shadowMesh.material.color.r,
            shadowMesh.material.color.g,
            shadowMesh.material.color.b
          )
        })
        .start()
    }
