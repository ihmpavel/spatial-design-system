...
AFRAME.registerComponent('checkbox', {
  ...
  createCheckbox() {
    ...
    const borderSize = 0.02 * sizeCoef
    ...
    const borderGeometry = new AFRAME.THREE.ExtrudeGeometry(borderShape, {
      depth: 0,
      bevelEnabled: false,
    })
    const checkboxGeometry = new AFRAME.THREE.ExtrudeGeometry(checkboxShape, {
      depth: 0.01,
      bevelEnabled: false,
    })
    ...
    const checkboxMaterial = new AFRAME.THREE.MeshBasicMaterial({
    ...
    const checkmarkGeometry = new AFRAME.THREE.ExtrudeGeometry(checkmarkShape, {
      depth: 0.01,
      bevelEnabled: false,
    })
    ...
    const checkmarkMaterial = new AFRAME.THREE.MeshBasicMaterial({
      color: this.data.checkmarkcolor,
    })
